...
public class NTSvc {
	...
	private int execServiceController(String cmd, String serviceName)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		String serviceName = "OpenOfficeUnoServer"; // 'remote access to
													// registry' service.

		System.out.println("State of service " + serviceName + " = "
				+ ntSvc.stateService(serviceName));
		System.out.println("Starting service " + serviceName + ", state = "
				+ ntSvc.startService(serviceName));
		Thread.sleep(5000);
		System.out.println("State of service " + serviceName + " = "
				+ ntSvc.stateService(serviceName));
		System.out.println("Stopping service " + serviceName + ", state = "
				+ ntSvc.stopService(serviceName));
	}
}
